        ...
        <div className="mt-10">
          <PortableText
            ...
            serializers={{
              ...
              strong: (props: any) => <strong className="text-xl" {...props} />,
            }}
          />
        </div>
      </article>
      ...
      {submitted ? (
        ...
        >
          ...
          <label className="block mb-5 ">
            ...
            <input
              className="shadow border rounded py-2 px-3 form-input mt-1 block w-full outline-transparent focus:outline-yellow-500"
          ...
          <div className="flex flex-col p-5">
            {Object.keys(errors).map((error) => (
              <span className="text-red-500 capitalize" key={uuidv4()}>
                - The {error} field is required
              </span>
            ))}
          </div>
